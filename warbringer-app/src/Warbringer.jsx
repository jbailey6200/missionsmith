...
const GAME_SYSTEMS = {
  '40k': {
    ...
    twists: [
      { name: 'Night Fighting', effect: 'Units over 12" away gain Stealth. Units over 24" cannot be targeted.' },
      ...
      { name: 'Warp Surge', effect: 'PSYKER units may attempt one additional psychic power per turn' },
  ...
  'bolt': {
    ...
    twists: [
      { name: 'Night Fighting', effect: 'Units beyond 12" require an order test to spot before shooting' },
      { name: 'Air Support', effect: 'Each turn, roll a die: on 5+ an air strike hits a randomly determined unit' },
      { name: 'Preparatory Bombardment', effect: 'Before Turn 1, all defender units take a D6 hit; pins apply' },
      { name: 'Dawn Assault', effect: 'Turn 1 uses Night Fighting rules; normal visibility from Turn 2' },
      { name: 'Hidden Setup', effect: 'Defender units start as hidden markers; reveal when spotted or firing' },
      { name: 'Tank War', effect: 'All armored vehicles gain +1 to their Damage Value' },
      { name: 'Dense Terrain', effect: 'All movement through terrain is halved; soft cover everywhere' },
      { name: 'Amphibious Assault', effect: 'Attacker first wave arrives from a water table edge via transports' },
    ],
    victories: [
